...
### 회원용 기능
1. **회원 가입/로그인**: 신규 회원 가입, 로그인, 비밀번호 재설정 기능 제공
2. **강좌 열람/신청**: 카테고리, 시간, 요일별 강좌 필터링 및 맞춤형 추천 제공
3. **마이페이지**: 개인 정보 조회/수정, 수강 내역 열람 및 취소 기능 제공

### 강사용 기능
1. **강좌 관리**: 신규 강좌 등록, 조회 및 수정 가능

### 관리자용 기능
1. **회원/강사 관리**: 회원 및 강사 목록 조회, 수정, 탈퇴 관리
2. **강좌 관리**: 강좌 신청 승인/반려 및 강의실 관리
3. **공지사항 관리**: 공지사항 등록, 수정, 삭제 가능


## 순서도
<div align="center">
<img width="500" alt="image" src="https://github.com/user-attachments/assets/e5113e46-c14b-449c-b2fd-73e07eb40a80">
</div>
...
### 데이터 관계도
<div align="center">
<img width="500" alt="image" src="https://github.com/user-attachments/assets/3ef6d27d-2458-4ef3-8569-0948f14dd39a">
</div>
...
- **황유진**: 관리자 메인, 강좌 개설 관리, 강의실 관리, 공지사항 기능
